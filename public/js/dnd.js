...
$( document ).ready(function() {
    ...
    // {
        ...
        let css = '<style>section{width:100%;height:100vh;}</style>';
        
        $(head).append(css);
    
        var modal = document.getElementById("myModal");
        var modalElement = document.getElementById('myModalElement');
        var myModalAnimation = document.getElementById('myModalAnimation');
        ...
        window.onclick = function(event) {
            ...
            if (event.target == modal  || event.target == modalElement || event.target == myModalAnimation) {
                modal.style.display = "none";
                modalElement.style.display = "none";
            myModalAnimation.style.display = "none";
            }
        }
        // iframe.find("section").click(function(e){
        

        //         console.log(e.target.tagName+'on clicked');
        // })
        // iframe.find("section").dblclick(function(e){
        //     e.target.attr('data-aos','fade-up');
        ...
        $(function(){
            ...
            iframe.find("section").on("click", function(e){
    ...
    var DragDropFunctions =
    {
        ...
        ProcessDragOverQueue : function($element,elementRect,mousePos)
        {
            ...
            this.dragoverqueue = [];
            // console.log(processing + "dan ");
            if(processing && processing.length == 3)
            {
                console.log('len' +processing.length);
                var $el = processing[0];
